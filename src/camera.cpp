...
void Camera::moveForward(float deltaTime, float cameraSpeed) {
    _position += _cameraFront * cameraSpeed * deltaTime;
}

void Camera::moveBackward(float deltaTime, float cameraSpeed) {
    _position -= _cameraFront * cameraSpeed * deltaTime;
}

void Camera::moveLeft(float deltaTime, float cameraSpeed) {
    _position -= _cameraRight * cameraSpeed * deltaTime;
}

void Camera::moveRight(float deltaTime, float cameraSpeed) {
    _position += _cameraRight * cameraSpeed * deltaTime;
}

void Camera::moveUp(float deltaTime, float cameraSpeed) {
    _position += _cameraUp * cameraSpeed * deltaTime;
}

void Camera::moveDown(float deltaTime, float cameraSpeed) {
    _position -= _cameraUp * cameraSpeed * deltaTime;
}
